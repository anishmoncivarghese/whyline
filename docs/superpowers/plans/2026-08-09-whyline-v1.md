...
- Produces: `gitq.Blame` dataclass with fields `sha: str`, `author: str`, `epoch: int`, `committed: bool`; `gitq.blame_line(root: Path, rel_path: str, line: int) -> Blame | None`; `gitq.commits_touching(root: Path, rel_path: str) -> list[tuple[str, int]]` newest first; `gitq.previous_commit_epoch(root: Path, rel_path: str, sha: str) -> int | None`; `gitq.GitUnavailable` exception.
